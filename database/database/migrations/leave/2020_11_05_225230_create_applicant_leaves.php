...
class CreateApplicantLeaves extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('applicant_leave_details', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('applicant_leave_details');
    }
}
