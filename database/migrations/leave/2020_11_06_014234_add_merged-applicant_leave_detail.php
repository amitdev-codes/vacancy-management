...
class AddMergedApplicantLeaveDetail extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('merged_applicant_leave_detail', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('merged_applicant_leave_detail');
    }
}
