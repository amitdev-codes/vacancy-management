          ...
          <tr>
            ...
            <th>पि.क्षे.</th>
             ...
             <tr>
                ...
                <td style="text-align: center">@if($pa->is_open==true){{$unicodeChar}} @else {{'-'}}@endif </td>
                <td style="text-align: center">@if($pa->is_female==true){{$unicodeChar}} @else {{'-'}}@endif </td>
                <td style="text-align: center">@if($pa->is_janajati==true){{$unicodeChar}} @else {{'-'}}@endif </td>
                <td style="text-align: center">@if($pa->is_madhesi==true){{$unicodeChar}} @else {{'-'}}@endif </td>
                <td style="text-align: center">@if($pa->is_dalit==true){{$unicodeChar}} @else {{'-'}}@endif </td>
                <td style="text-align: center">@if($pa->is_handicapped==true){{$unicodeChar}} @else {{'-'}}@endif </td>
                <td style="text-align: center">@if($pa->is_remote_village==true){{$unicodeChar}} @else{{'-'}}@endif </td>
