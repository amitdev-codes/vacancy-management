  ...
  @foreach($admit_card as $value)
    <div class="admit_card" style="height:auto">
        <header>
            ...
            <img style="height:40px; width:80px;margin-top:120px;margin-left:0px;position: absolute;z-index: 2;" src="{{asset('img/nbsir.png')}}" />
                ...
                <div class="box"> <img style="height:40px; width:127px;" src="{{asset($value->signature_sample)}}" onerror="this.onerror=null;this.  src='../images/sign.jpg';" style="height: 40px;" />
                </div>
        </header>
            ...
            <tr>
              ...
              @for ($i=0;$i<@count($papers);$i++)
               <tr>
                ...
                <td style="text-align: center">@if($value->is_open==true){{$unicodeChar}}@else {{'-'}}@endif </td>
                <td style="text-align: center">@if($value->is_female==true){{$unicodeChar}}@else {{'-'}}@endif </td>
                <td style="text-align: center">@if($value->is_janajati==true){{$unicodeChar}}@else {{'-'}}@endif </td>
                <td style="text-align: center">@if($value->is_madhesi==true){{$unicodeChar}}@else {{'-'}}@endif </td>
                <td style="text-align: center">@if($value->is_dalit==true){{$unicodeChar}}@else {{'-'}}@endif </td>
                <td style="text-align: center">@if($value->is_handicapped==true){{$unicodeChar}}@else {{'-'}}@endif </td>
                <td style="text-align: center">@if($value->is_remote_village==true){{$unicodeChar}}@else{{'-'}}@endif </td>
