    ...
    @foreach ($admit_card as $value)
        <div class="admit_card">
            <header class="d-flex justify-content-between align-items-start">
                <div class="logo">
                    ...
                    <div class="photo position-relative">
                        <img src="{{ asset('img/nb_sir.png') }}"
                            style="height:40px; width:80px;margin-top:120px;position: absolute;z-index: 2;"
                            alt="Nb Sir">

                        <img src="{{ asset($value->photo) }}" style="height: 150px;width: 130px;margin-top: 4px;"
                            onerror="this.onerror=null;this.src='../images/avatar.jpg';" alt="Applicant Photo">

                        <div class="box mt-2">
                            <img src="{{ asset($value->signature_sample) }}"
                ...
                <div class="photo position-relative">
                    <img src="{{ asset($value->citizenship) }}" style="height: 300px;width: 250px;margin-top: 4px;"
            ...
            <div class="mt-3">
                <div class="d-flex justify-content-between">
                    <div><b>Applicant ID : </b>{{ $value->applicant_id }}</div>
                    <div style="margin-left:70px"><b>नागरिकता नं/जारी जिल्ला:</b>
                        {{ $value->citizenship_no }}/{{ $value->citizenship_district }}</div>
                </div>
                <div class="d-flex justify-flex-end">
                    <div><b>उम्मेदवारको नाम,थर: </b>{{ $value->applicant_name }}</div>
                    <div style="margin-left:150px">
                        <b>रोल नम्बर: </b>{{ $value->exam_roll_no }}
                    </div>
                </div>
            </div>
            ...
            <table style="margin:0px;font-size:14px;" class='mt-2 center_details' border="1" cellspacing="0"
                ...
                <tr>
                    ...
                    <td rowspan="4" class="nepali_td">{{ $value->opening_type }}</td>

                    <td rowspan="4">
                        {{ $value->designation }}-{{ $value->work_service }}/{{ $value->service_group }}/{{ $value->work_level }}
                    </td>
                    @php
                        $unicodeChar = "\u{2713}";
                    @endphp
