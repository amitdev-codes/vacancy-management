...
<head>
    ...
    <style>
        @font-face {font-family: "Mangal"; src: url({{public_path("/fonts/mangal.ttf")}}) format("truetype");}
...
<body class="main">
    <section class="invoice">
        <div class="box">
            <div id='headertop'>
                <h2 style="text-align:center;" class="nepali_td"><b>नेपाल टेलिकम</b></h3><br />
                    <h3 style="text-align:center;margin-top:-20px;"><b>(नेपाल दूरसंचार कम्पनी लिमिटेड)</b></h5> <br />
                ...
                <div>
                    ...
                    <table border="1" class='table' style="border-collapse: collapse;">
                        ...
                        <tbody>
                            ...
                            <?php if( $loop->iteration == '1') { $yogyeta = 'माथिल्लो';} else if( $loop->iteration == '2') { $yogyeta = 'न्युनतम';} else { $yogyeta = 'थप';}?>
                            <tr>
                                <td>
                                    <b>{{ $yogyeta }}</b>
                                </td>
