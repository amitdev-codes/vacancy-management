  ...
  <div class="panel panel-default">
   ...
   @endif
    ...
    <div class="box">
        ...
        <a href="/admin/export_service_history/{{$va_id}}" target="_blank"><button type="button" class="btn btn-primary">Export Service History</button></a>
        @endif
        @endif
            @if($isApplicant=='true')
  ...
  <table id="table_dashboard" class="table table-hover table-striped table-bordered">
                    ...
                    @foreach($merged_data as $key => $merged_data)
                      ...
                      @endif 
                        ...
                        <a class="btn btn-xs btn-success btn-edit" title="Edit Data" href="/admin/merged_data/edit/{{$merged_data->id}}">
                        <i class="fa fa-pencil"></i></a>
                        
                        @endif
                        @if($merged_data->is_approved==0)
                        <a class="btn btn-xs btn-danger" title="Delete Data" href="/admin/merged_data/delete/{{$merged_data->id}}" onclick="return confirm('Are you sure to Delete merged data?')">
    ...
    <button class="btn btn-info"><a href="/admin/verify_merged_data/{{$id}}/{{$va_id}}"  onclick="return confirm('Are you sure to Verify merged data?')" style="color:white">Verify</a></button>
    </div>
    @endif
    @if($merged_data->is_verified==1 && $merged_data->is_approved==0 )
    <div align="right" style="margin: 10px;">

    <button class="btn btn-info"><a href="/admin/approve_merged_data/{{$id}}/{{$va_id}}"  onclick="return confirm('Are you sure to approve merged data?')" style="color:white">Approve</a></button>
