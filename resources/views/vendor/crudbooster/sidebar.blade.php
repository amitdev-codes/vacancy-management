...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <div class='main-menu'>
            ...
            <!-- Sidebar Menu -->
            <ul class="sidebar-menu" style="white-space: initial;">
                <li class="header">{{cbLang("menu_navigation")}}</li>
                {{-- <li class="">
                    <a href='{{Route("generateController")}}'><i class='fa fa-key'></i>
                         <span>Send entrance card</i></a>
                </li>
                <li class="">
                    <a href='{{Route("roll_number")}}'><i class='fa fa-key'></i>
                         <span>Rollnumber generate</i></a>
                </li>
                <li class="">
                    <a href='{{Route("generateController")}}'><i class='fa fa-key'></i>
                         <span>Generate report</i></a>
                </li>
                <li class="">
                    <a href='{{Route("generateController")}}'><i class='fa fa-key'></i>
                         <span>View Training</i></a>
                </li> --}}
