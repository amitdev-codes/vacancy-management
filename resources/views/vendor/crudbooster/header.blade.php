...
<header class="main-header">
    ...
    <!-- Logo -->
    <a href="{{url(config('crudbooster.ADMIN_PATH').'/dashboard')}}" title='{{Session::get('appname')}}' class="logo" ><img src="{{asset('images/logo.png')}}" height="40px;"> {{CRUDBooster::getSetting('appname')}}</a>
