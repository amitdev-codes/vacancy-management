...
<div class='panel panel-default'>
      ...
      <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6">
          <div class="form-group">
            ...
            <input type="text" name="notice_no" id="notice_no" class="form-control input-lg" placeholder="Notice No." disabled value='         @php
        ...
        <div class="col-xs-6 col-sm-12 col-md-12">
          <div class="form-group">
            ...
            <input type="text" name="vacancy_post" id="vacancy_post" class="form-control input-lg" placeholder="Post" disabled value='@php
            foreach($vacancy_data as $vd){
             echo $vd->post.",";
            }
           @endphp'>
  ...
  <div class="panel-footer">
    <div class="row">
      <input type="hidden" name="post_id" id="post_id" value="{{$vacancy_data[0]->id}}" />
      <input type="hidden" name="exam_group_id" id="exam_group_id" value="{{$exam_group_id}}" />
    ...
    <div class="col-xs-6 col-md-3">
      <a href="{{ route('admitcard.generate', ['id' => $vacancy_data[0]->id,'exam_group_id'=>$exam_group_id])}}">
