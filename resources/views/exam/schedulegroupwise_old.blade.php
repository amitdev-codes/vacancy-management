...
<div class='panel panel-default'>
  ...
  <div class="panel-body">
      ...
      <div class="row">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6">
          <div class="form-group">
            ...
            <input type="text" name="notice_no" id="notice_no" class="form-control input-lg" placeholder="Notice No." disabled value='<?php foreach($vacancy_data as $vd){echo "[".$vd->ad_no."]";}?>'>
          </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6">
          <div class="form-group">
            <label>Ad Title</label>
            <input type="text" name="ad_title" id="ad_title" class="form-control input-lg" placeholder="Ad Title" disabled value="{{$vacancy_data[0]->ad_title}}">
          </div>
        </div>
        <div class="col-xs-6 col-sm-6 col-md-6">
          ...
          <div class="form-group">
            ...
            @foreach($vacancy_data as $vd)
            <input type="text" name="vacancy_post" id="vacancy_post" class="form-control input-lg" placeholder="Post" disabled value='{{$vd->post}}'>
            @endforeach        
            </div>
        </div>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3">
          <div class="form-group">
            ...
            <input type="text" name="published_date_bs" id="published_date_bs" class="form-control input-lg" placeholder="Published Date BS"
              disabled value="{{$vacancy_data[0]->publish_date_bs}}">
          </div>
        </div>
        ...
        <div class="col-xs-3 col-sm-3 col-md-3">
          <div class="form-group">
            ...
            <input type="text" name="published_date_ad" id="published_date_ad" class="form-control input-lg" placeholder="Published Date AD"
              disabled value="{{$vacancy_data[0]->publish_date_ad}}">
          </div>
        </div>
        ...
        <form method="post" action="/app/update_exam">
          ...
          <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group">
              ...
              <input type="text" value="{{$exam_details_data[0]->roll_prefix}}" name="roll_prefix" id="roll_prefix" class="form-control input-lg"
          ...
          <div class="col-xs-3 col-sm-3 col-md-3">
            <div class="form-group">
              ...
              <input type="number" value="{{$exam_details_data[0]->roll_start_value}}" name="roll_start" id="roll_start" class="form-control input-lg"
    ...
    <div class="row">
      ...
      {{-- <div class="col-xs-6 col-md-3">
        <!-- <input type="submit" name="submit" id="submit" value="Send Mail" class="btn btn-warning btn-block btn-lg" onclick="return confirm('Are you sure you want to send email?')"> -->
        <a href="{{ route('admitcard.generate', ['id' => $vacancy_data->id])}}">
