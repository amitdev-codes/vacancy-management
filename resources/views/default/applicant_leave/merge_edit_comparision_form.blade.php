...
@section('content')
        ...
        @if(CRUDBooster::getCurrentMethod() != 'getProfile' && $button_cancel)
			...
			@else
      @if(strpos(CRUDBooster::mainpath(), 'merged_data/edit') !== false)
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-10">
                              @if($button_cancel && CRUDBooster::getCurrentMethod() != 'getDetail')                       
                                ...
                                @else 
                                  @if(strpos(CRUDBooster::mainpath(), 'merged_data_leave/edit') !== false)
                                  ...
                                  @else
                                    <input id="mismatched_key" value="{{$row->mismatched_key}}" hidden>
                                  @endif
                                @endif
                              @endif
