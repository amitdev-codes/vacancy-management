...
switch ($page_title) {
    ...
    case "Applicant Experience Info":
        ...
        break;
    case "Applicant Leave detail":
        $applicantLeaveDetail="active";
        break;
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
        <ul class="nav nav-tabs">
            ...
            @if($isNtStaff)
            <li role="presentation" class="{{$applicantLeaveDetail}}"><a href="/{{$prefix}}/applicant_leave_details{{$query}}"><i class='fa fa-plane'></i> - Leave Details</a></li>
   ...
   @endif
    ...
    <div class="box">
        <div class="box-header">
            ...
            <a href="{{CRUDBooster::adminPath()}}/applicant_leave_details/add" id="btn_add_new_data" class="btn btn-sm btn-success" title="Add Data">
