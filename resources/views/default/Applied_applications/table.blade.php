            ...
            <script type="text/javascript">
                ...
                <div class="card">
                  ...
                  <table id='table_dashu' class="table table-hover table-striped table-bordered">
                    <thead>
                    <tr class="active">

                        @if($button_table_action)
                        @if(CRUDBooster::isUpdate() || CRUDBooster::isDelete() || CRUDBooster::isRead())
                            <th width='{{$button_action_width?:"auto"}}' style="text-align:left;min-width:110px;">{{trans("crudbooster.action_label")}}</th>
                        @endif
                      @endif
          ...
          @if($isApplicant!='true')
                  <div class="pull-right pagination" style="margin:10px;">
                        <p class="label label-success" style="font-weight: bold;font-size: 16px;">Number of records: <?php echo $result->total();?></p>
                   </div>
                  @endif
