...
@section('content')
    ...
    <div class="btn-group">
        @if($internal_candidates)
            <a href="{{ route('internal_candidates_report', ['print' => "print"]) }}">
    ...
    <header style="width:1100px;">
        <div class="left header panel panel-primary nepali_td">
            ...
            <div class='panel-footer'>
                <p class="nepali_td">आन्तरिक प्रतियोगितात्मक परीक्षाको लागि Online मार्फत दर्ता भएका आवेदन सम्बन्धि संख्यात्मक विवरण  </p>
            </div>
        </div>
    </header>
        ...
        <div class="panel panel-primary">
            <div class="panel-body" style="overflow-x:auto;">
                <table class="table table-striped table-bordered  nepali_td"
                    ...
                    @endphp
                    @foreach ($internal_candidates as $value)
                        @php
