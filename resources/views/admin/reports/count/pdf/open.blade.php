...
<header style="width:1100px;">
    <div class="left header panel panel-primary nepali_td">
        <div clas="panel-body">
            <div class="heading-report">
                <h5 class="nepali_td"><img src="{{asset('images/logo.png')}}" height="50px;" width="50px;"
                                           style="margin-right:20px;margin-bottom:-20px;">नेपाल टेलिकम</h5>
                <br>
        ...
        <div class='panel-footer'>
            <p class="nepali_td">खुला तथा समावेसी प्रतियोगितात्मक परीक्षाको लागि Online मार्फत दर्ता भएका आवेदन सम्बन्धि
                संख्यात्मक विवरण </p>
        </div>
    </div>
</header>
<div class="container" style="width:1100px;margin-left:50px;">
