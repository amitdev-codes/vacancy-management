<div>
    @php
        ...
        $query = "?applicant_id=$applicantID &va_id=$vaID";
    @endphp

        <div class="panel-heading">
            <ul class="nav nav-tabs">
                <li role="presentation" class="@if($page_title==='Edit Applicant Profile'|| $page_title==='Applicant Profile') {{ 'active' }} @endif"><a href="/{{$prefix}}/applicant_profile/edit/{{$applicantID}}"><i class='fa fa-user'></i> - Profile</a></li>
                <li role="presentation" class="@if($page_title==='Applicant Family Information') {{ 'active' }} @endif"><a href="/{{$prefix}}/applicant_family_info/edit/{{ $applicantID}}/{{$query}}"><i class='fa fa-group'></i> - Family Details</a></li>
