...
.sweet-alert p,h2{
 ...
 <div class="panel panel-success nepali_td">
   ...
   <form role="form" action="{{$esewa_login_url}}" target="_blank" method="POST">
     {!! csrf_field() !!}
     <div class="panel-body">
      ...
      <input value="{{$transactionid}}" name="pid" type="hidden">
       ...
       <input type="hidden" name="su" value="{{route('esewaSuccess',['id'=>$token])}}" />
       <input type="hidden" name="fu" value="{{route('esewaFail')}}" />
       <div class="form-check">
        <input class="form-check-input accept" type="checkbox" value="" id="defaultCheck1">
         <label class="form-check-label" for="defaultCheck1">
           यो {{$taxtype_name}} निर्धारण मैले {{Session::get('client_name')}} कार्यालयमा पेश गरेको विवरणको आधारमा
     ...
     <div class="panel-footer">
       <button type="submit" class="submitbutton"onclick="return checkbox();" style='border: none;  padding: 0px;'>
        <img src="{{ asset('images/esewa1.png') }}" style="width:100px"></button>
     </div>
   </form>
 </div>
