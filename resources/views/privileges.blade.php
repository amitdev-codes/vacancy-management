            ...
            <form method='post' action='{{ (@$row->id)?route("PrivilegesControllerPostEditSave")."/$row->id":route("PrivilegesControllerPostAddSave") }}'>
                ...
                <div class="box-body">
                    ...
                    <div id='privileges_configuration' class='form-group'>
                        ...
                        @endpush
                        <table class='table table-striped table-hover table-bordered' id="paginate1">
                            <thead>
                            <tr class='active'>
                            ...
                            <tr class='info'>
                                ...
                                <th>&nbsp;</th>
                                <th>&nbsp;</th>
                                <td align="center"><input title='Check all vertical' type='checkbox' id='is_visible' disabled/></td>
                                <td align="center"><input title='Check all vertical' type='checkbox' id='is_create' disabled/></td>
                                <td align="center"><input title='Check all vertical' type='checkbox' id='is_read' disabled/></td>
                                <td align="center"><input title='Check all vertical' type='checkbox' id='is_edit' disabled/></td>
                                <td align="center"><input title='Check all vertical' type='checkbox' id='is_delete' disabled/></td>
                            </tr>
                            </thead>
                            <tbody>
                            <?php $no = 1;?>
