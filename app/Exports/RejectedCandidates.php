...
class RejectedCandidates implements FromView,WithHeadings,ShouldAutoSize,WithEvents
{
    ...
    FROM
        ...
        if ($opening_type->opening_type_id == 1) {
            ...
            return view("rejected_candidate.open_excel_report",$data);
        } elseif ($opening_type->opening_type_id == 2) {
            return view("rejected_candidate.internal_excel_report",$data);
        }else{
            return view("rejected_candidate.file_promotion_excel",$data);
        }
