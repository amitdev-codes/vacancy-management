...
class LokSewaReportInternalExportExcel implements FromQuery, WithHeadings, WithMapping,ShouldAutoSize,WithEvents
{
    use Exportable;
    public $ad_id;
    public $designation;
    ...
    public function headings(): array
    {
        ...
        return [
              ...
              [],
              [
                'क्र.सं', 'रोल नं', 'उम्मेदवारको नामथर', 'लिङ्ग','फोटो', 'हस्ताक्षर', 'टोक्न  नं', 'स्थायी ठेगाना', 'मोबाईल नं', 'बाजेको नाम', 'बाबु/आमाको नाम', 'नागरिकता नं,जारि जिल्ला', 'बुजाएको दस्तुर'
              ]
        ];
    }
    ...
    public function registerEvents(): array
    {
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) use($details) {
                ...
                // $workSheet->getStyle('E9:K9')->applyFromArray($groupHeaderStyle);
                ...
                $workSheet->getStyle('A1:M8')->applyFromArray($titleStyle);
                $specificRangeStyle = [
                    'font' => [
                        'size' => 10,
                    ],
                ];
                $workSheet->getStyle('A4:M8')->applyFromArray($specificRangeStyle);
                #rows datas
                ...
                $workSheet->getStyle('A9:M9')->applyFromArray($headerStyle);
                // Make headers wrap text
                $workSheet->getStyle('A9:M9')->getAlignment()->setWrapText(true);
                $dataStyle = [
                    'borders' => [
                        'allBorders' => [
                            'borderStyle' => \PhpOffice\PhpSpreadsheet\Style\Border::BORDER_THIN,
                ...
                $workSheet->getColumnDimension('E')->setWidth(12); // फोटो
                $workSheet->getColumnDimension('F')->setWidth(12); // हस्ताक्षर
                $workSheet->getColumnDimension('G')->setWidth(10); // टोक्न  नं
                $workSheet->getColumnDimension('H')->setWidth(30); // स्थायी ठेगाना
                $workSheet->getColumnDimension('I')->setWidth(15); // मोबाईल नं
                $workSheet->getColumnDimension('J')->setWidth(18); // बाजेको नाम
                $workSheet->getColumnDimension('K')->setWidth(30); // बाबु/आमाको नाम
                $workSheet->getColumnDimension('L')->setWidth(25); // नागरिकता नं,जारि जिल्ला
                ...
                $workSheet->getStyle('A7:M7')->applyFromArray($styleArray);
                ...
                $workSheet->setCellValue('A7', "        पद संख्या:  $total");
                $workSheet->mergeCells('A7:M7');
                $workSheet->getStyle('A7')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_LEFT);

                $workSheet->setCellValue('A8', 'आन्तरिक प्रतियोगितात्मक तर्फका उम्मेदवारहरुको स्वीकृत नामावली');
