...
class AppliedGroupWiseReportController extends ReportBaseController
{
    public function cbInit()
    {
        # START CONFIGURATION DO NOT REMOVE THIS LINE
        // $this->table               = "vacancy_apply";
        $this->report_name = "Applied Group Wise Count";
        $this->title_field = "id";
        $this->limit = 20;
    ...
    sum(is_open) as open
    ,sum(is_paid) as paid,
    work_level_code, designation_en as designation,designation_id,vacancy_ad_id
    FROM
        vw_vacancy_applicant
        where is_paid=1
        GROUP BY designation_en,designation_id,ad_no,vacancy_ad_id
        ) as count_sql";
        ...
        $this->col[] = array("label" => "Total Paid Applicant", "name" => "paid");
