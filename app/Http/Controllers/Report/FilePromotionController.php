...
use App\Exports\file_promotionAccepted;

class FilePromotionController extends \App\Http\Controllers\BaseCBController
{
    public $ad_id = 0;
    ...
    public function getIndex()
    {
        ...
        $this->cbView('reports.file_promotion_accepted', $data);
...
//         $sql = "select distinct t2.exam_roll_no as roll, t1.* from vw_vacancy_post_applicant_profile t1
    ...
    public function generateExcel($id)
    {
       ...
       Session::put('file_promotion_accepted_candidates_id',$id);

        
        return Excel::download(new file_promotionAccepted($id), 'users.xlsx');
