...
class AppliedCountDateWiseReportController extends ReportBaseController
{
    public function cbInit()
    {
        # START CONFIGURATION DO NOT REMOVE THIS LINE
        // $this->table               = "vacancy_apply";
        $this->report_name = "Applied Applicants Date Wise Count";
        $this->title_field = "id";
        $this->limit = 20;
        $this->orderby = "applied_date_ad,asc";
        ...
        $this->table = "(SELECT   1 id,applied_date_ad, count(1) as cnt,
        sum(is_female) AS female,
        sum(is_dalit) AS dalit,
        sum(is_handicapped) as handicapped,
        sum(is_madhesi) AS madhesi,
        sum(is_janajati) as janajati,
        sum(is_remote_village) as remote_village,
        sum(is_open) as open,vacancy_ad_id,designation_id
        FROM vw_vacancy_applicant
        GROUP BY applied_date_ad,vacancy_ad_id,designation_id
        ) as count_sql";
        # START COLUMNS DO NOT REMOVE THIS LINE
        $this->col = array();
        $this->col[] = array("label" => "Applied Date(AD)", "name" => "applied_date_ad");
        $this->col[] = array("label" => "Unique Applicant", "name" => "cnt");
