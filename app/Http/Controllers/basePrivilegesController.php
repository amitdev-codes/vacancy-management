...
class basePrivilegesController extends  \crocodicstudio\crudbooster\controllers\CBController 
{
    ...
    public function postEditSave($id)
    {
        ...
        CRUDBooster::redirect(CRUDBooster::adminpath('privileges'), trans("crudbooster.alert_update_data_success", [
            'module' => "Privilege",
            'title' => $row->name,
        ]), 'success');
    }
