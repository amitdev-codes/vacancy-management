...
class AdminMstAreaClassController extends BaseCBController
{
    ...
    public function cbInit()
    {
        ...
        $this->form[] = ['label' => 'Gender', 'name' => 'gender', 'type' => 'number-c', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'cmp-ratio' => '4:12:12'];
