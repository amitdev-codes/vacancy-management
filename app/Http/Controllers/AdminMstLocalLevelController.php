<?php namespace App\Http\Controllers;
	...
	class AdminMstLocalLevelController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'District Id','name'=>'district_id','type'=>'select2','validation'=>'required|min:1|max:255','width'=>'col-sm-10','datatable'=>'mst_district,name_en'];
