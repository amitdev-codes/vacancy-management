...
class AdminMstExamBoardController extends BaseCBController
{
    ...
    public function cbInit()
    {
        ...
        $this->table = "mst_exam_board";
        # END CONFIGURATION DO NOT REMOVE THIS LINE

        # START COLUMNS DO NOT REMOVE THIS LINE
        $this->col = [];
        $this->col[] = ["label" => "Code", "name" => "code"];
        $this->col[] = ["label" => "Exam Board", "name" => "name_en"];
        $this->col[] = ["label" => "परीक्षा बोर्ड", "name" => "name_np"];
        ...
        $this->form[] = ['label' => 'Name', 'name' => 'name_en', 'type' => 'text-c', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10', 'cmp-ratio' => '4:12:12'];
        $this->form[] = ['label' => 'Name (Nepali)', 'name' => 'name_np', 'type' => 'text-c', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10', 'cmp-ratio' => '4:12:12'];
