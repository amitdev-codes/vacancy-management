<?php namespace App\Http\Controllers;
	...
	class AdminRelatedStaffController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Post','name'=>'post','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:related_staff','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			...
			//$this->form[] = ["label"=>"Post","name"=>"post","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:related_staff","placeholder"=>"Please enter a valid email address"];
