...
class AdminVacancyPaymentController extends BaseCBController
{
    ...
    public function cbInit()
    {
        ...
        $this->col[] = ["label" => "Padate Ad", "name" => "paid_date_ad"];
        $this->col[] = ["label" => "Padate Bs", "name" => "paid_date_bs"];
        ...
        $this->form[] = ['label' => 'Designation Id', 'name' => 'designation_id', 'type' => 'select2', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10', 'datatable' => 'mst_designation,id'];
        $this->form[] = ['label' => 'Padate Ad', 'name' => 'paid_date_ad', 'type' => 'date', 'validation' => 'required|date', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Padate Bs', 'name' => 'paid_date_bs', 'type' => 'text', 'validation' => 'required|min:1|max:255', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Pareceipt No', 'name' => 'paid_receipt_no', 'type' => 'number', 'validation' => 'required|numeric|min:1', 'width' => 'col-sm-10'];
        $this->form[] = ['label' => 'Pareceipt Id', 'name' => 'paid_receipt_id', 'type' => 'select2', 'validation' => 'required|integer|min:0', 'width' => 'col-sm-10', 'datatable' => 'paid_receipt,id'];
